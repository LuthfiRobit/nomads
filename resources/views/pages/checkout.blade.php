            ...
            <div class="row">
                ...
                <div class="col-lg-8 pl-lg-0">
                    <div class="card card-details">
                        ...
                        <p>Trip to Bromo, Probolinggo, Indonesia</p>
                        <div class="attendee">
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline">
                                ...
                                <select name="inputVisa" id="inputVisa" class="custom-select mb-2 mr-sm-2">
                                    ...
                                    <option value="N/ACCOUNT">N/ACCOUNT</option>
                                </select>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="join-container">
                        <a href="{{url('/checkout/success')}}" class="btn btn-block btn-join-now mt-3 py-2">I Have Made
                            Payment</a>
                    </div>
